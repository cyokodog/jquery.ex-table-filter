            ...
            $.each(appends, function(i){
                ...
                if(append.to.length && append.values){
                    ...
                    if(/^(checkbox|radio)$/.test(append.type)){
                        ...
                        $.each(arr, function(j){
                            var v = arr[j];
                            if(j == 0 && append.addBlank) addCheckboxOrRadio(append.blankLabel, append.blankValue);
                    ...
                    if(append.type == 'select'){
                        ...
                        var addOption = function(label, value) {
                            $('<option/>').val(value).text(label).appendTo(selectEl);
                        };
                        if(append.addBlank) addOption(append.blankLabel, append.blankValue);
                        $.each(arr, function(j){
                            var v = arr[j];
                            addOption(v, v);
                        });
